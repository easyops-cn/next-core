import type { StoryboardNode, StoryboardNodeRoot } from "./interfaces.js";
...
export function traverse(
  nodeOrNodes: StoryboardNode | StoryboardNode[] | undefined,
  callback: TraverseCallback
): void {
...
function traverseNodes(
  nodes: StoryboardNode[] | undefined,
  callback: TraverseCallback,
  path: StoryboardNode[]
): void {
  if (!nodes) {
