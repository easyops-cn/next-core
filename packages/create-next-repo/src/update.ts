...
export async function update(
    ...
    if (fs.existsSync(readmePath)) {
      if (
        fs
          ...
          .includes("Generated by [@next-core/create-next-repo]")
      ) {
  ...
  function syncPackageJson() {
    ...
    targetPackageJson.devDependencies["@next-core/dev-dependencies"] =
      packageJson.devDependencies["@next-core/dev-dependencies"];
  ...
  function fixHomepage(): void {
    if (
      ...
      // Fix root homepage.
      targetPackageJson.homepage = `https://github.com/easyops-cn/${repoName}`;
    }
  ...
  function fixDevDependencies(): void {
    const json = require(require.resolve(
      "@next-core/dev-dependencies/package.json",
      {
        paths: [targetDir],
      }
    ));
