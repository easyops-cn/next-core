    ...
    return isBig ? (
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor="#868686" offset="0%"></stop>
          ...
          >
            <stop stopColor="#B2B2B2" offset="0%"></stop>
            <stop stopColor="#DEDEDE" offset="100%"></stop>
          </linearGradient>
          <path
        ...
        <g
          ...
          fillRule="evenodd"
        >
          <g id="新建仪表盘-3" transform="translate(-392.000000, -240.000000)">
            <g id="编组-50" transform="translate(36.000000, 134.000000)">
              <g
                id="插图/空表格--白色背景备份"
