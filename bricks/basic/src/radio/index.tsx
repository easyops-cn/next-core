...
import type { GeneralIcon, GeneralIconProps } from "@next-core/icons";
...
class Radio extends FormItemElement implements RadioProps {
  /**
   * @kind string
   * @required true
   * @default -
   ...
   * @group basicFormItem
   */
  @property({ attribute: false }) accessor name: string;
  ...
  accessor options: GeneralOption[];
   ...
   * @group basicFormItem
   */
  @property({ attribute: false }) accessor message: Record<string, string>;
   ...
   */
  @property()
  accessor size: "large" | "middle" | "small";
  ...
  accessor customStyle: React.CSSProperties;
